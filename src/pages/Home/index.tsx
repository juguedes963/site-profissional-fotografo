        ...
        <main className=''>
            ...
            <section className='w-full h-screen bg-#000000ad' id='portifolio'>
                <div className='flex flex-col w-full h-full justify-center items-center'>
                    ...
                    <h1 className='md:text-9xl text-4xl  text-white'>Meu Portifólio</h1>
                    <h2 className='md:text-7xl text-3xl   text-gray-300'>
                        Fotografia
                    </h2>
            ...
            <section className='w-full h-screen  md:pb-36 bg-transparent-black' id='profissional'>
                ...
                <div className='flex flex-col md:flex-row w-full h-full justify-center items-center'>
                    ...
                    <div className='w-full px-5 md:w-1/2 md:ml-10 flex flex-col justify-start items-start'>
                        <h1 className='text-white text-3xl mb-5  w-full '>
                            Gabriel Lima
                        </h1>
                        <p className='text-white w-full md:w-1/2 text-sm md:text-lg  tracking-wide leading-loose'>
                        ...
                        <div>
                            <h4 className='text-xl  text-white mt-5'>
                            ...
                            <div className='mt-5   grid grid-cols-2  '>
                                <span
                                    ...
                                    className='border-2 w-11/12 cursor-pointer border-white text-sm text-white px-2 py-2 rounded-3xl mx-4 my-2 flex hover:bg-white hover:text-black font-semibold justify-center'>
                                    Newborn
                                </span>
                                <span onClick={() => navigate('/details', {
                                    state: photos

                                })} className='border-2 w-11/12 cursor-pointer border-white text-white text-sm px-2 py-2 rounded-3xl mx-4 my-2 flex justify-center hover:bg-white hover:text-black font-semibold '>
                                    Casuais
                                </span>
                                <span onClick={() => navigate('/details', {
                                    state: photosMatch
                                    ...
                                    className='border-2 mx-4 w-full cursor-pointer border-white text-white  text-sm px-2 py-2 rounded-3xl my-2 flex justify-center hover:bg-white hover:text-black font-semibold '>
                                    Casamentos
                                </span>
                            </div>
                        </div>
            ...
            <section className='w-full md:h-full h-types bg-transparent-black  md:pb-20' id='casual'>
                ...
                <div className='flex flex-col w-full h-full justify-center items-center md:pt-10'>
                    <div className='flex flex-col cursor-pointer hover:border-b-2' >
                        <h3 className='text-white text-left  text-3xl  mb-5 '
                            onClick={() => navigate('/details', {
                                state: photos
            ...
            <section className='w-full md:h-full h-types bg-transparent-black   md:pb-20' id='casamento'>
                ...
                <div className='flex flex-col w-full h-full justify-center md:pt-10 items-center'>
                    <div className='flex flex-col cursor-pointer hover:border-b-2'>
                        <h3 className='text-white text-left  text-3xl  mb-5 ' onClick={() => navigate('/details', {
                            state: photosMatch
